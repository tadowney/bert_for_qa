...
flags.DEFINE_string(
    "input_jsonl", 'nq-train-0-10.jsonl.gz',
    "Gzipped files containing NQ examples in Json format, one per line.")

flags.DEFINE_string("output_tfrecord", './train_syn_0-10_record',
...
def main(_):
  ...
  instances = []
  for examples in get_examples(FLAGS.input_jsonl):
