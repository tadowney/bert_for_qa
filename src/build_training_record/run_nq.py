...
flags.DEFINE_string(
    "predict_file", 'v1.0_sample_nq-dev-sample.jsonl.gz',
...
def get_synonym(word):
  ...
  if word in unique_synonyms:
    unique_synonyms.remove(word)
  unique_synonyms = list(unique_synonyms)

  if unique_synonyms == []:
    return vocab[randrange(30000)]
  else:
    return unique_synonyms[randrange(len(unique_synonyms))]
